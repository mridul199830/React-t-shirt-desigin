...
function Satting({color, upperText, lowerText, memeImg, textSize, textColor}) {
    return (
        <div className='card bg-light cintainer'>
            ...
            <hr/>
            <h4>uplood file</h4>
            <input onChange={memeImg} type='file' className=' from-control-file mb-2' placeholder='uplood file'/>
            <hr/>
            <h4>text size</h4>
            <input onChange={textSize} type='range' min='12' max='45'/>
            <hr/>
            <h4>text color</h4>
            <select onclick={textColor} className='form-control from-control-sm mb-2'>
                <option>white</option>
                <option>black</option>
                <option>red</option>
                <option>blue</option>
